...
<body>
    <nav class="navbar navbar-light navbar-expand-md fixed-top navbar-shrink py-3" id="mainNav">
        <div class="container"><a class="navbar-brand d-flex align-items-center" href="/afterloginhome"><span>Agent
            ...
            <div class="row pt-5">
                ...
                <div class="col-12 col-lg-10 mx-auto">
                    <div class="text-center position-relative"><img class="img-fluid"
                            src="assets/img/valorant/valorant.jpeg" style="width: 800px;"></div>
                </div>
            </div>
        </div>
    </header>
    <section>
        <div class="container py-4 py-xl-5 my-3">
            <div class="row">
                <div class="col-md-6">
                    <h3 class="display-6 fw-bold pb-md-4">Description About Valorant Agent&nbsp;<span
                            class="underline">API</span></h3>
                </div>
                <div class="col-md-6 pt-2">
                    <p class="text-muted mb-4">Agent Valo provides a RESTful API (Application Programming Interface)
                        that you can use to create various applications that require data in the form of valorant
                        agents. Valorant agent data is taken directly from the Valorant-API web to maintain data
                        accuracy. However, if you find invalid data, please report it to our team. Agent Valo is easy to
                        integrate because it uses a REST architecture with a response format in the form of JSON which
                        is supported by almost all programming languages. Imagine being able to create a feature that
                        displays an automatic list of Valorant agents on the website or create mobile applications for
                        Android, iOS, and others. Have you got an idea to make an application with Agent Valo? Please
                        sign up your account & log in to access all API content!</p>
                </div>
            </div>
            <div class="col-md-6 text-center mx-auto my-5">
                <h3 class="display-6 fw-bold pb-md-4">Why Use Valorant Agent&nbsp;<span class="underline">API?</span>
                </h3>
            </div>
            <div class="row gy-4 gy-md-0">
                ...
                <div class="col-md-6 order-first order-md-last">
                    <div><img class="rounded img-fluid w-100 fit-cover" style="min-height: 300px;"
                            src="assets/img/illustrations/design.svg"></div>
                </div>
            </div>
            <!-- <div class="col-md-6 text-center mx-auto my-5">
