...
<body>
    <nav class="navbar navbar-light navbar-expand-md fixed-top navbar-shrink py-3" id="mainNav">
        <div class="container"><a class="navbar-brand d-flex align-items-center" href="/password"><span>Agent
            ...
            <div class="row d-flex align-items-center">
                ...
                <div class="col-md-5 col-xl-4 text-center text-md-start">
                    ...
                    <form action="{{ route('password.action') }}" method="POST">
                        @csrf
                        <div class="mb-3"><input class="shadow form-control" type="password" name="old_password"
                                placeholder="Password"></div>
                        <div class="mb-3"><input class="shadow form-control" type="password" name="new_password"
                                placeholder="New Password"></div>
                        <div class="mb-3"><input class="shadow form-control" type="password"
                                name="new_password_confirmation" placeholder="New Password Confirmation"></div>
                        <div class="mb-5"><button class="btn btn-primary shadow" type="submit">Change
                                password</button></div>
                    </form>
                </div>
            </div>
